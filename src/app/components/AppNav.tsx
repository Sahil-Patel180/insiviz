  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
        ...
        <button
          onClick={onLogout}
          style={{ fontFamily: share, fontSize: "0.62rem", letterSpacing: "0.14em", color: `rgba(${MR},0.40)`, background: "transparent", border: "none", cursor: "pointer", transition: "color 0.15s" }}
          onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.color = MINT)}
          onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.color = `rgba(${MR},0.40)`)}
        >
          log_out
        </button>
      </div>
